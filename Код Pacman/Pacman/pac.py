...
class Pac(pygame.sprite.Sprite):
	...
	# получает все изображения, необходимые для анимации конкретного действия игрока
	...
	# обновление с помощью sprite / sheets
	...
	def update(self):
		# Таймер, основанный на количестве кадров в секунду
